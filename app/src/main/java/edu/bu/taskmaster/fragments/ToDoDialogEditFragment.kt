...
import edu.bu.taskmaster.databinding.FragmentToDoDialogBinding
import edu.bu.taskmaster.utils.ToDoData
import com.google.android.material.textfield.TextInputEditText


class ToDoDialogEditFragment : DialogFragment() {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(taskId: String, task: String,taskStatus: String) =
            ToDoDialogEditFragment().apply {
                arguments = Bundle().apply {
                    putString("taskId", taskId)
                    putString("task", task)
                    putString("taskStatus", taskStatus)
                }
            }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (arguments != null){
            ...
            toDoData = ToDoData(arguments?.getString("taskId").toString() ,arguments?.getString("task").toString(),arguments?.getString("taskStatus").toString())
